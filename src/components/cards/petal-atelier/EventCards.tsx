...
function FloralIcon({ petalPrimary, petalSecondary, gold, goldLight }: { petalPrimary: string; petalSecondary: string; gold: string; goldLight: string }) {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <ellipse cx="14" cy="8" rx="3.5" ry="6" fill={petalPrimary}/>
      <ellipse cx="14" cy="20" rx="3.5" ry="6" fill={petalPrimary} transform="rotate(180 14 14)"/>
      <ellipse cx="8" cy="14" rx="3.5" ry="6" fill={petalPrimary} transform="rotate(90 14 14)"/>
      <ellipse cx="20" cy="14" rx="3.5" ry="6" fill={petalPrimary} transform="rotate(-90 14 14)"/>
      <ellipse cx="9.5" cy="9.5" rx="3" ry="5" fill={petalSecondary} opacity="0.7" transform="rotate(-45 9.5 9.5)"/>
      <ellipse cx="18.5" cy="9.5" rx="3" ry="5" fill={petalSecondary} opacity="0.7" transform="rotate(45 18.5 9.5)"/>
      <ellipse cx="9.5" cy="18.5" rx="3" ry="5" fill={petalSecondary} opacity="0.7" transform="rotate(45 9.5 18.5)"/>
      <ellipse cx="18.5" cy="18.5" rx="3" ry="5" fill={petalSecondary} opacity="0.7" transform="rotate(-45 18.5 18.5)"/>
